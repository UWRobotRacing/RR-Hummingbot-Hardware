...
#ifndef INCLUDE_HB19_RF24_H_
#define INCLUDE_HB19_RF24_H_
...
typedef struct rf24_config
{
  ...
  void HB19_RF24_Init(uint16_t _cepin, uint16_t _cspin);
  ...
  */
  ...
  void HB19_RF24_Init_SPI(uint16_t _cepin, uint16_t _cspin, uint32_t spispeed );
   ...
   */
  uint8_t HB19_RF24_begin(void);

  /**
   * Checks if the chip is connected to the SPI bus
   */
  uint8_t HB19_RF24_isChipConnected();
   ...
   * @endcode
   */
  void HB19_RF24_startListening(void);
   ...
   * @endcode
   */
  void HB19_RF24_stopListening(void);
   ...
   */
  uint8_t HB19_RF24_available(void);
   ...
   */
  void HB19_RF24_read( void* buf, uint8_t len );
   ...
   */
  uint8_t HB19_RF24_write( const void* buf, uint8_t len );
...
s   *
  ...
  void HB19_RF24_openWritingPipe(const uint8_t *address);
  ...
  void HB19_RF24_openReadingPipe(uint8_t number, const uint8_t *address);
   ...
   * @endcode
   */
  void HB19_RF24_printDetails(void);
   ...
   * @return True if there is a payload available, false if none is
   */
  uint8_t HB19_RF24_available_pipe(uint8_t* pipe_num);
  ...
  */
  uint8_t HB19_RF24_write_NOACK( const void* buf, uint8_t len, const uint8_t multicast );
   ...
   * @return True if the payload was delivered successfully false if not
   */
  uint8_t HB19_RF24_writeFast( const void* buf, uint8_t len );
  ...
  */
  uint8_t HB19_RF24_writeFast_NOACK( const void* buf, uint8_t len, const uint8_t multicast );
   ...
   */
  uint8_t HB19_RF24_writeBlocking( const void* buf, uint8_t len, uint32_t timeout );
   ...
   *
   */
   uint8_t HB19_RF24_txStandBy_timeout(uint32_t timeout, uint8_t startTx);
// uint8_t startTx = 0
   ...
   */
  void HB19_RF24_writeAckPayload(uint8_t pipe, const void* buf, uint8_t len);
   ...
   */
  uint8_t HB19_RF24_isAckPayloadAvailable(void);
  ...
  //originally
  // void HB19_RF24_whatHappened( uint8_t &tx_ok, uint8_t &tx_fail, uint8_t &rx_ready);
  void HB19_RF24_whatHappened( uint8_t *tx_ok, uint8_t *tx_fail, uint8_t *rx_ready);
   ...
   * @return True if the payload was delivered successfully false if not
   */
  void HB19_RF24_startFastWrite( const void* buf, uint8_t len, const uint8_t multicast, uint8_t startTx );
//uint8_t startTx = 1
   ...
   *
   */
  void HB19_RF24_startWrite( const void* buf, uint8_t len, const uint8_t multicast );
   ...
   */
  uint8_t HB19_RF24_flush_tx(void);
   ...
   */
  uint8_t HB19_RF24_testCarrier(void);
   ...
   */
  uint8_t HB19_RF24_testRPD(void) ;
  ...
  uint8_t HB19_RF24_isValid( rf24_config_t *rf24Config) {
	  return rf24Config->ce_pin != 0xff && rf24Config->csn_pin != 0xff; }
   ...
   */
  void HB19_RF24_closeReadingPipe( uint8_t pipe ) ;
  ...
  */
  ...
  void HB19_RF24_setAddressWidth(uint8_t a_width);
   ...
   */
  void HB19_RF24_setRetries(uint8_t delay, uint8_t count);
   ...
   */
  void HB19_RF24_setChannel(uint8_t channel);
   ...
   */
  uint8_t HB19_RF24_getChannel(void);
   ...
   */
  void HB19_RF24_setPayloadSize(uint8_t size);
   ...
   */
  uint8_t HB19_RF24_getPayloadSize(void);
   ...
   */
  uint8_t HB19_RF24_getDynamicPayloadSize(void);
   ...
   * enableDynamicPayloads() to enable on all pipes.
   */
  void HB19_RF24_enableAckPayload(void);
   ...
   *
   */
  void HB19_RF24_enableDynamicPayloads(void);
   ...
   *
   */
  void HB19_RF24_disableDynamicPayloads(void);
   ...
   * if its not.
   */
  uint8_t HB19_RF24_isPVariant(void) ;
   ...
   */
  void HB19_RF24_setAutoAck(uint8_t enable);
   ...
   * @param enable Whether to enable (true) or disable (false) auto-acks
   */
  void HB19_RF24_setAutoAck_pipe( uint8_t pipe, uint8_t enable ) ;
   ...
   */
  void HB19_RF24_setPALevel ( uint8_t level );
   ...
   */
   uint8_t HB19_RF24_getPALevel( void );
   ...
   */
  uint8_t HB19_RF24_setDataRate(rf24_datarate_e speed);
   ...
   */
  void HB19_RF24_setCRCLength(rf24_crclength_e length);
   ...
   */
  void HB19_RF24_disableCRC( void ) ;
  ...
  */
  void HB19_RF24_maskIRQ(uint8_t tx_ok,uint8_t tx_fail,uint8_t rx_ready);
  ...
  */
   ...
   */
  void HB19_RF24_openReadingPipe_address(uint8_t number, uint64_t address);
   ...
   * @param address The 40-bit address of the pipe to open.
   */
  void HB19_RF24_openWritingPipe_address(uint64_t address);
   ...
   * @return Current value of status register
   */
  uint8_t HB19_RF24_flush_rx(void);
   ...
   */
  void HB19_RF24_csn(uint8_t mode);
   ...
   */
  void HB19_RF24_ce(uint8_t level);
   ...
   * @return Current value of status register
   */
  uint8_t HB19_RF24_read_register(uint8_t reg, uint8_t* buf, uint8_t len);
   ...
   */
  uint8_t HB19_RF24_read_byte_register(uint8_t reg);
   ...
   * @return Current value of status register
   */
  uint8_t HB19_RF24_write_register(uint8_t reg, const uint8_t* buf, uint8_t len);
   ...
   * @return Current value of status register
   */
  uint8_t HB19_RF24_write_byte_register(uint8_t reg, uint8_t value);
   ...
   * @return Current value of status register
   */
  uint8_t HB19_RF24_write_payload(const void* buf, uint8_t len, const uint8_t writeType);
   ...
   * @return Current value of status register
   */
  uint8_t HB19_RF24_read_payload(void* buf, uint8_t len);
   ...
   * @return Current value of status register
   */
  uint8_t HB19_RF24_get_status(void);
   ...
   * @warning Does nothing if stdout is not defined.  See fdevopen in stdio.h
   */
  void HB19_RF24_print_status(uint8_t status);
   ...
   * @warning Does nothing if stdout is not defined.  See fdevopen in stdio.h
   */
  void HB19_RF24_print_observe_tx(uint8_t value);
   ...
   */
  void HB19_RF24_print_byte_register(const char* name, uint8_t reg);
//qty = 1
   ...
   * @param qty How many successive registers to print
   */
  void HB19_RF24_print_address_register(const char* name, uint8_t reg);
  //qty = 1
   ...
   */
  void HB19_RF24_toggle_features(void);

  /**
   * Built in spi transfer function to simplify repeating code repeating code
   */

  uint8_t HB19_RF24_spiTrans(uint8_t cmd);
